...
namespace RagdollDemo
{
    ...
    class Ragdoll
    {
        ...
        public Ragdoll(DynamicsWorld ownerWorld, Vector3 positionOffset)
        {
            ...
            transform = Matrix.Multiply(Matrix.CreateRotationZ(-PI_2), offset * Matrix.CreateTranslation(-0.35f, 1.45f, 0));
		    bodies[(int)BodyPart.LeftUpperArm] = LocalCreateRigidBody(1, transform, shapes[(int)BodyPart.LeftUpperArm]);

            transform = Matrix.Multiply(Matrix.CreateRotationZ(-PI_2), offset * Matrix.CreateTranslation(-0.7f, 1.45f, 0));
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, 0.15f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, -0.15f, 0));
            hingeC = new HingeConstraint(bodies[(int)BodyPart.Pelvis], bodies[(int)BodyPart.Spine], ref localA, ref localB);
            hingeC.SetLimit(-PI_4, PI_2);
	        joints[(int)Joint.PelvisSpine] = hingeC;
            hingeC.SetDbgDrawSize(ConstraintDebugSize);

            ownerWorld.AddConstraint(joints[(int)Joint.PelvisSpine], true);


            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_2), Matrix.CreateTranslation(0, 0.30f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_2), Matrix.CreateTranslation(0, -0.14f, 0));
            coneC = new ConeTwistConstraint(bodies[(int)BodyPart.Spine], bodies[(int)BodyPart.Head], ref localA, ref localB);
            coneC.SetLimit(PI_4, PI_4, PI_2);
            joints[(int)Joint.SpineHead] = coneC;
            coneC.SetDbgDrawSize(ConstraintDebugSize);

		    ownerWorld.AddConstraint(joints[(int)Joint.SpineHead], true);


            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, -PI_4 * 5), Matrix.CreateTranslation(-0.18f, -0.18f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, -PI_4 * 5), Matrix.CreateTranslation(0, 0.225f, 0));
            coneC = new ConeTwistConstraint(bodies[(int)BodyPart.Pelvis], bodies[(int)BodyPart.LeftUpperLeg], ref localA, ref localB);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, -0.225f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, 0.185f, 0));
            hingeC = new HingeConstraint(bodies[(int)BodyPart.LeftUpperLeg], bodies[(int)BodyPart.LeftLowerLeg], ref localA, ref localB);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_4), Matrix.CreateTranslation(0.18f, -0.10f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_4), Matrix.CreateTranslation(0, 0.225f, 0));
            coneC = new ConeTwistConstraint(bodies[(int)BodyPart.Pelvis], bodies[(int)BodyPart.RightUpperLeg], ref localA, ref localB);
            coneC.SetLimit(PI_4, PI_4, 0);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, -0.225f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, 0.185f, 0));
            hingeC = new HingeConstraint(bodies[(int)BodyPart.RightUpperLeg], bodies[(int)BodyPart.RightLowerLeg], ref localA, ref localB);
            hingeC.SetLimit(0, PI_2);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, (float)Math.PI), Matrix.CreateTranslation(-0.2f, 0.15f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_2), Matrix.CreateTranslation(0, -0.18f, 0));
            coneC = new ConeTwistConstraint(bodies[(int)BodyPart.Spine], bodies[(int)BodyPart.LeftUpperArm], ref localA, ref localB);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, 0.18f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, -0.14f, 0));
            hingeC = new HingeConstraint(bodies[(int)BodyPart.LeftUpperArm], bodies[(int)BodyPart.LeftLowerArm], ref localA, ref localB);
            hingeC.SetLimit(0, PI_2);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, 0), Matrix.CreateTranslation(0.2f, 0.15f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, 0, PI_2), Matrix.CreateTranslation(0, -0.18f, 0));
            coneC = new ConeTwistConstraint(bodies[(int)BodyPart.Spine], bodies[(int)BodyPart.RightUpperArm], ref localA, ref localB);
            coneC.SetLimit(PI_2, PI_2, 0);
            ...
            localA = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, 0.18f, 0));
            localB = Matrix.Multiply(Matrix.CreateFromYawPitchRoll(0, PI_2, 0), Matrix.CreateTranslation(0, -0.14f, 0));
            hingeC = new HingeConstraint(bodies[(int)BodyPart.RightUpperArm], bodies[(int)BodyPart.RightLowerArm], ref localA, ref localB);
