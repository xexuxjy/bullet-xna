...
namespace BulletXNA.BulletCollision
{
    public class ClipPolygon
    {
        ...
        {
            return point.Dot(new Vector3(plane.X, plane.Y, plane.Z)) - plane.W;
        }
        ...
        //fixme - see if this can take a raw array.
                               ...
                               ref int clipped_count)
        {
            ...
            if (_classif != _prevclassif)
            {
                ...
                VecBlend(ref clipped[clipped_count], ref point0, ref point1, blendfactor);
                clipped_count++;
            }
            if (!_classif)
            {
        ...
        */
        public static int PlaneClipTriangle(
                               ...
                               ref Vector3 point1,
                               ref Vector3 point2,
                               Vector3[] clipped // an allocated array of 16 points at least
                               )
        {
            int clipped_count = 0;
