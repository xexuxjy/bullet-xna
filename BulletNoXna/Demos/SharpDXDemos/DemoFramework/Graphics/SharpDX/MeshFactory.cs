...
namespace DemoFramework.SharpDX
{
    ...
    {
        public global::SharpDX.Matrix WorldTransform;
        public uint Color;
    ...
    public class MeshFactory : DemoFramework.MeshFactory
    {
        ...
        void InitInstanceData(CollisionObject colObj, CollisionShape shape, ref Matrix transform)
        {
            if (shape.ShapeType == BroadphaseNativeType.CompoundShape)
            {
                ...
                {
                    Matrix childTransform = child.m_transform * transform;
                    InitInstanceData(colObj, child.m_childShape, ref childTransform);
                }
            }
            /*
        ...
        public void InitInstancedRender(ObjectArray<CollisionObject> objects)
        {
            // Clear instance data
