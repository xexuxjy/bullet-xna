...
namespace DemoFramework
{
    ...
    public struct PositionColored
    {
        ...
        public static readonly int Stride = 3 * sizeof(float) + sizeof(int);
    ...
    public abstract class MeshFactory
    {
        ...
        {
            Vector3 size = shape.GetHalfExtentsWithMargin();
        ...
        public static Vector3[] CreateConvexHull(ConvexHullShape shape)
        {
            ...
            var indices = hull.m_indices;
            var points = hull.m_vertices;
        ...
        {
            object vertexBuffer, indexBuffer;
            int numVerts, numFaces;
            PHY_ScalarType vertsType, indicesType;
            int vertexStride, indexStride;
            shape.MeshInterface.GetLockedReadOnlyVertexIndexBase(out vertexBuffer, out numVerts, out vertsType, out vertexStride,
                out indexBuffer, out indexStride, out numFaces, out indicesType, 0);
        ...
        */
        ...
        {
            Vector3 planeOrigin = shape.GetPlaneNormal() * shape.PlaneConstant;
            Vector3 vec0, vec1;
            PlaneSpace1(shape.GetPlaneNormal(), out vec0, out vec1);
        ...
        static Vector3[] CreateTriangleMesh(TriangleMeshShape shape)
        {
            ...
            PHY_ScalarType vertsType, indicesType;
            int vertexStride, indexStride;
            meshInterface.GetLockedReadOnlyVertexIndexBase(out vertexBuffer, out numVerts, out vertsType, out vertexStride,
                out indexBuffer, out indexStride, out numFaces, out indicesType, 0);
