...
namespace BulletXNA.BulletCollision
{
    public class GImpactBvh
    {
        ...
        public void BuildSet()
        {
            ...
            primitive_boxes.Capacity = m_primitive_manager.PrimitiveCount;
        ...
        {
            get { return m_primitive_manager.IsTrimesh; }
        }

        //! node count
        public int NodeCount
        {
            get { return m_box_tree.NodeCount; }
        }
        ...
        {
            if (boxset1.NodeCount == 0 || boxset2.NodeCount == 0) return;
