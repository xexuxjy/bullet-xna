...
void btHingeConstraint::getInfo2InternalUsingFrameOffset(btConstraintInfo2* info, const btTransform& transA,const btTransform& transB,const btVector3& angVelA,const btVector3& angVelB)
{
	...
	btGeometryUtil::PrintMatrix(g_file,"rbAFrame",m_rbAFrame);
	btGeometryUtil::PrintMatrix(g_file,"rbBFrame",m_rbBFrame);
	btGeometryUtil::PrintMatrix(g_file,"transA",transA);
	btGeometryUtil::PrintMatrix(g_file,"transB",transB);
	}
	btTransform trA = transA*m_rbAFrame;
	btTransform trB = transB*m_rbBFrame;
	...
	if(g_file && btBulletDebug::debugConstraints)
	{
	btGeometryUtil::PrintMatrix(g_file,"trA",trA);
	btGeometryUtil::PrintMatrix(g_file,"trB",trB);
	}
