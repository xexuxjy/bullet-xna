...
namespace BulletXNA.BulletDynamics
{
    ...
    {
        public Generic6DofConstraint(RigidBody rbA, RigidBody rbB,  ref Matrix frameInA,  ref Matrix frameInB ,bool useLinearReferenceFrameA) : base(TypedConstraintType.D6,rbA,rbB)
        {
            m_frameInA = frameInA;
            m_frameInB = frameInB;
        ...
        protected Generic6DofConstraint(RigidBody rbB, ref Matrix frameInB, bool useLinearReferenceFrameB) : base(TypedConstraintType.D6,GetFixedBody(),rbB)
        {
            m_frameInB = frameInB;
        ...
        */
        ...
        {
            GetInfo2NonVirtual(info,m_rbA.GetCenterOfMassTransform(),m_rbB.GetCenterOfMassTransform(), m_rbA.LinearVelocity,m_rbB.LinearVelocity,m_rbA.GetAngularVelocity(), m_rbB.GetAngularVelocity());        
        }
