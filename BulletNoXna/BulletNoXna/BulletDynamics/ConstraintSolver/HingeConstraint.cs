...
namespace BulletXNA.BulletDynamics
{
    public class HingeConstraint : TypedConstraint
    {
        ...
        public HingeConstraint(RigidBody rbA, RigidBody rbB, ref Vector3 pivotInA, ref Vector3 pivotInB, ref Vector3 axisInA, ref Vector3 axisInB, bool useReferenceFrameA) : base(TypedConstraintType.Hinge,rbA,rbB)
        {
            m_angularOnly = false;
        ...
        public HingeConstraint(RigidBody rbA, ref Vector3 pivotInA, ref Vector3 axisInA, bool useReferenceFrameA) : base(TypedConstraintType.Hinge,rbA)
        {
            m_angularOnly = false;
            m_enableAngularMotor = false;
            m_useReferenceFrameA = useReferenceFrameA;
        ...
        public HingeConstraint(RigidBody rbA, RigidBody rbB, ref Matrix rbAFrame, ref Matrix rbBFrame, bool useReferenceFrameA) : base(TypedConstraintType.Hinge,rbA,rbB)
        {
            m_rbAFrame = rbAFrame;
            m_rbBFrame = rbBFrame;
            m_angularOnly = false;
        ...
        public HingeConstraint(RigidBody rbA, ref Matrix rbAFrame, bool useReferenceFrameA) : base(TypedConstraintType.Hinge,rbA)
        {
            m_rbAFrame = rbAFrame;
            m_rbBFrame = rbAFrame;
            m_angularOnly = false;
        ...
        public void	SetAxis(ref Vector3 axisInA)
        {
            ...
            m_rbBFrame.Translation = Vector3.Transform(pivotInA,m_rbA.GetCenterOfMassTransform());
            MathUtil.SetBasis(ref m_rbBFrame,ref rbAxisB1,ref rbAxisB2,ref axisInB);
        }
