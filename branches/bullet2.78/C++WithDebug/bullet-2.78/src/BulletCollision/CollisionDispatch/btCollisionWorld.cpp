...
void	btCollisionWorld::updateSingleAabb(btCollisionObject* colObj)
{
	...
	if(g_file && btBulletDebug::debugCollisionWorld)
	{
		btGeometryUtil::PrintVector(g_file,"updateSingleAabbMin",minAabb);
		btGeometryUtil::PrintVector(g_file,"updateSingleAabbMax",maxAabb);
	}
