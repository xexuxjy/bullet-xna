...
if(clampedSimulationSteps > 1)
{
	int ibreak = 0;
}
if(g_file && btBulletDebug::debugDiscreteDynamicsWorld)
		{
			fprintf(g_file,"Stepsimulation numClamped[%d] timestep[%2.4f]\n", clampedSimulationSteps, fixedTimeStep);
		}
...
void	btDiscreteDynamicsWorld::internalSingleStepSimulation(btScalar timeStep)
{
	...
	if(g_file != NULL && btBulletDebug::debugDiscreteDynamicsWorld)
	{
		fprintf(g_file,"internalSingleStepSimulation\n");
	}
...
void	btDiscreteDynamicsWorld::solveConstraints(btContactSolverInfo& solverInfo)
{
	...
	if(g_file && btBulletDebug::debugDiscreteDynamicsWorld)
	{
		fprintf(g_file,"solveConstraints\n");
	}
...
//	btAssert(0);
	...
	if(g_file && btBulletDebug::debugDiscreteDynamicsWorld)
	{
		fprintf(g_file,"buildAndProcessIslands\n");
	}
