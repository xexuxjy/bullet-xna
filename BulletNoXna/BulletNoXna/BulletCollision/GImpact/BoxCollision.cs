...
namespace BulletXNA.BulletCollision
{
    ...
    public struct AABB
    {
        ...
        public void ApplyTransform(ref Matrix trans)
        {
            ...
            Vector3 textends = new Vector3(extends.Dot(trans._basis.GetRow(0).Absolute()),
        ...
        public void ApplyTransformTransCache(ref BT_BOX_BOX_TRANSFORM_CACHE trans)
        {
		    ...
		    Vector3 textends = new Vector3(extends.Dot(trans.m_R1to0.GetRow(0).Absolute()),
        ...
        {
            center = new Vector3((m_max + m_min) * 0.5f);
            extend = new Vector3(m_max - center);
        }
        ...
        */
        ...
        public bool OverlappingTransCache(ref AABB box, ref BT_BOX_BOX_TRANSFORM_CACHE transcache, bool fulltest)
        {
            ...
            //Taken from OPCODE
            Vector3 ea, eb;//extends
            Vector3 ca, cb;//extends
        ...
        public static float Mat3DotCol(ref IndexedBasisMatrix mat, ref Vector3 vec3, int colindex)
        {
            return vec3.X * mat[0,colindex] + vec3.Y * mat[1,colindex] + vec3.Z * mat[2,colindex];
        }

        public static float Mat3DotCol(IndexedBasisMatrix mat, ref Vector3 vec3, int colindex)
        {
            return vec3.X * mat[0, colindex] + vec3.Y * mat[1, colindex] + vec3.Z * mat[2, colindex];
        }
        ...
        public bool CollideTriangleExact(ref Vector3 p1, ref Vector3 p2, ref Vector3 p3, ref Vector4 triangle_plane)
        {
            ...
            //First axis
            Vector3 diff = (v2 - v1);
            Vector3 abs_diff = diff.Absolute();
    ...
    public struct BT_BOX_BOX_TRANSFORM_CACHE
    {
        ...
        {
            Matrix temp_trans = trans0.Inverse();
        ...
        public void CalcFromFullInvert(ref Matrix trans0, ref Matrix trans1)
        {
            ...
            m_T1to0 = m_R1to0 * (-trans0.Translation);

            m_T1to0 += m_R1to0 * trans1.Translation;
        ...
        {
            return new Vector3(m_R1to0._el0.Dot(ref point) + m_T1to0.X,
