			 ...
			 case PHY_INTEGER:
				 {
					 for (gfxindex=0;gfxindex<numtriangles;gfxindex++)
					 {
						 unsigned int* tri_indices= (unsigned int*)(indexbase+gfxindex*indexstride);
							int index1 = tri_indices[0];
							int index2 = tri_indices[1];
							int index3 = tri_indices[2];
						...
						if(g_file && debugStridingMesh && !callback->graphics())
						{
							btGeometryUtil::PrintVector(g_file,"SMI:T0",triangle[0]);
							btGeometryUtil::PrintVector(g_file,"SMI:T1",triangle[1]);
							btGeometryUtil::PrintVector(g_file,"SMI:T2",triangle[2]);
						}
