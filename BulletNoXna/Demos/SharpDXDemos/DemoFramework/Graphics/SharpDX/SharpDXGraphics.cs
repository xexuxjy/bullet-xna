...
namespace DemoFramework.SharpDX
{
    public class SharpDXGraphics : Graphics
    {
        ...
        public override BulletXNA.LinearMath.IDebugDraw GetPhysicsDebugDrawer()
        {
        ...
        ShaderBytecode LoadShader(string name, ShaderFlags flags)
        {
            ...
            StreamReader reader = new StreamReader(assembly.GetManifestResourceStream("DemoFramework.Graphics.SharpDX." + name));
