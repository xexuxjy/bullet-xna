...
namespace BasicDemo
{
    class Physics : PhysicsContext
    {
        ...
        public Physics()
        {
            ...
            // create the ground
            CollisionShape groundShape = new BoxShape(new Vector3(50, 1, 50));
            ...
            CollisionShape colShape = new BoxShape(new Vector3(1.0f));
            ...
            for (k = 0; k < ArraySizeY; k++)
            {
                for (i = 0; i < ArraySizeX; i++)
                {
                    for (j = 0; j < ArraySizeZ; j++)
                    {
                        ...
                        Vector3 t = new Vector3(0, 20, 0);
                        body.Translate(ref t);
