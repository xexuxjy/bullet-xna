...
void	btBvhTriangleMeshShape::processAllTriangles(btTriangleCallback* callback,const btVector3& aabbMin,const btVector3& aabbMax) const
{
	...
	struct	MyNodeOverlapCallback : public btNodeOverlapCallback
	{
		...
		virtual void processNode(int nodeSubPart, int nodeTriangleIndex)
		{
			...
			if (g_file && btBulletDebug::debugBVHTriangleMesh)
			{
				fprintf(g_file,"BVH Triangle\n");
				btGeometryUtil::PrintVector(g_file, m_triangle[0]);
				btGeometryUtil::PrintVector(g_file, m_triangle[1]);
				btGeometryUtil::PrintVector(g_file, m_triangle[2]);
			}
