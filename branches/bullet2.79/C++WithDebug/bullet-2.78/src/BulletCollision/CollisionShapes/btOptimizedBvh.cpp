...
void btOptimizedBvh::build(btStridingMeshInterface* triangles, bool useQuantizedAabbCompression, const btVector3& bvhAabbMin, const btVector3& bvhAabbMax)
{
	...
	if(g_file && debugOptimizedBVH)
	{
		for (int i = 0; i < m_quantizedContiguousNodes.size(); ++i)
		{
			btQuantizedBvhNode bvhn = m_quantizedContiguousNodes[i];
			fprintf(g_file,"QNode[%d] Esc[%d] min[%d,%d,%d] max[%d,%d,%d]\n", i, 
				bvhn.m_escapeIndexOrTriangleIndex, bvhn.m_quantizedAabbMin[0], bvhn.m_quantizedAabbMin[1], 
				bvhn.m_quantizedAabbMin[2], bvhn.m_quantizedAabbMax[0], bvhn.m_quantizedAabbMax[1], bvhn.m_quantizedAabbMax[2]);
		}
