...
//		const float r = m_radius / sqrtf(2.0f);
        ...
        public bool TestContainment()
        {
	        for(int p=0;p<8;p++)
	        {
		        ...
		        if(p==0)		LocalPt = m_localCenter + new Vector3(m_extents.X, m_extents.Y, m_extents.Z);
		        else if(p==1)	LocalPt = m_localCenter + new Vector3(m_extents.X, m_extents.Y, -m_extents.Z);
		        else if(p==2)	LocalPt = m_localCenter + new Vector3(m_extents.X, -m_extents.Y, m_extents.Z);
		        else if(p==3)	LocalPt = m_localCenter + new Vector3(m_extents.X, -m_extents.Y, -m_extents.Z);
		        else if(p==4)	LocalPt = m_localCenter + new Vector3(-m_extents.X, m_extents.Y, m_extents.Z);
		        else if(p==5)	LocalPt = m_localCenter + new Vector3(-m_extents.X, m_extents.Y, -m_extents.Z);
		        else if(p==6)	LocalPt = m_localCenter + new Vector3(-m_extents.X, -m_extents.Y, m_extents.Z);
		        else if(p==7)	LocalPt = m_localCenter + new Vector3(-m_extents.X, -m_extents.Y, -m_extents.Z);
