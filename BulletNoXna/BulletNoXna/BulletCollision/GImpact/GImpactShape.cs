...
namespace BulletXNA.BulletCollision
{
    ...
    public abstract class GImpactShapeInterface : ConcaveShape
    {
        ...
        {
            m_shapeType = BroadphaseNativeType.GImpactShape;
        ...
        */
        ...
        {
            if (m_box_set.NodeCount == 0) return false;
            return true;
        }
    ...
    public class CompoundPrimitiveManager : IPrimitiveManagerBase
    {
        ...
        {
            get { return m_compoundShape.GetNumChildShapes(); }
        }
    ...
    public class GImpactCompoundShape : GImpactShapeInterface
    {
        ...
        */
        public override void GetChildAabb(int child_index, ref Matrix t, out Vector3 aabbMin, out Vector3 aabbMax)
        {
            ...
            {
                Matrix temp = t * m_childTransforms[child_index];
    ...
    */
    public class GImpactMeshShapePart : GImpactShapeInterface
    {
        ...
        */
        ...
        public override int GetNumChildShapes()
        {
            return m_primitive_manager.PrimitiveCount;
        }
        ...
        */
        ...
        public override string Name
        {
            get { return "GImpactMeshShapePart"; }
        }
        ...
        public int VertexCount
        {
            get { return m_primitive_manager.VertexCount; }
        }
        ...
        public override float Margin
        {
            ...
            set
            {
                m_primitive_manager.m_margin = value;
                PostUpdate();
            }
        }
