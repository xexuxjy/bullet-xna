...
namespace BulletXNA.BulletCollision
{
    ...
    public class GIM_TRIANGLE_CONTACT
    {
        ...
        public void MergePoints(ref Vector4 plane, float margin, Vector3[] points, int point_count)
        {
            m_point_count = 0;
    ...
    public class PrimitiveTriangle
    {
        ...
        */
        //public static ObjectArray<Vector3> temp_points = new ObjectArray<Vector3>(GIM_TRIANGLE_CONTACT.MAX_TRI_CLIPPING);
        //public static ObjectArray<Vector3> temp_points1 = new ObjectArray<Vector3>(GIM_TRIANGLE_CONTACT.MAX_TRI_CLIPPING);

        public static Vector3[] temp_points = new Vector3[GIM_TRIANGLE_CONTACT.MAX_TRI_CLIPPING];
        public static Vector3[] temp_points1 = new Vector3[GIM_TRIANGLE_CONTACT.MAX_TRI_CLIPPING];

        public int ClipTriangle(PrimitiveTriangle other, Vector3[] clipped_points)
        {
            // edge 0
        ...
        */
        static Vector3[] clipped_points = new Vector3[(GIM_TRIANGLE_CONTACT.MAX_TRI_CLIPPING)];
    ...
    */
    public class TriangleShapeEx : TriangleShape
    {
        ...
        {
            Vector3 tv0 = t * m_vertices1[0];
            Vector3 tv1 = t * m_vertices1[1];
            Vector3 tv2 = t * m_vertices1[2];
        ...
        public void ApplyTransform(ref Matrix t)
        {
            Vector3.Transform(m_vertices1, ref t, m_vertices1);
        }
