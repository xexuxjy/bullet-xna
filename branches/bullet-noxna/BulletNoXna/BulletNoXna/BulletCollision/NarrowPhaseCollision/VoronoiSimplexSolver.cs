...
namespace BulletXNA.BulletCollision
{
    ...
    public class VoronoiSimplexSolver : ISimplexSolverInterface
    {
        ...
        public int PointOutsideOfPlane(ref Vector3 p, ref Vector3 a, ref Vector3 b, ref Vector3 c, ref Vector3 d)
        {
            ...
            float signp = Vector3.Dot(ref pa, ref normal);// [AP AB AC]
            float signd = Vector3.Dot(ref da, ref normal);// [AD AB AC]
        ...
        public bool ClosestPtPointTriangle(ref Vector3 p, ref Vector3 a, ref Vector3 b, ref Vector3 c, ref SubSimplexClosestResult result)
        {
            ...
            float d1 = Vector3.Dot(ref ab, ref ap);
            float d2 = Vector3.Dot(ref ac, ref ap);
            if (d1 <= 0f && d2 <= 0f)
            {
            ...
            float d3 = Vector3.Dot(ref ab, ref bp);
            float d4 = Vector3.Dot(ref ac, ref bp);
            if (d3 >= 0f && d4 <= d3)
            {
            ...
            float d5 = Vector3.Dot(ref ab, ref cp);
            float d6 = Vector3.Dot(ref ac, ref cp);
